...
- [Dependency.ml](https://github.com/MarisaKirisame/ant/blob/3f698ae0668870bef6238bbd6e86d957c0e08647/lib/Dependency.ml):
  ...
  We deliberately do not use Concat to synthesize general semantic rules. It
  shares finite effect evidence; exact-state rendezvous remains the reuse proof.
  Candidate-local difference explanation is documented in state-difference.md.
