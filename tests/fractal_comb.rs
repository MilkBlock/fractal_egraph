...
fn smooth_segments_stack_across_coarse_injection_and_keep_positioned_effects() {
    ...
    e.parse_and_run_program(
      ...
      (let seed (CoarseRuleComposition (MoreParents (Empty) (NoParents)) (Rule "inject") (PNil)))
      (let a (SmoothRuleComposition (MoreParents seed (NoParents)) (Rule "r") (RNil)))
      (let b (SmoothRuleComposition (MoreParents a (NoParents)) (Rule "r") (RNil)))
      (let boundary (CoarseRuleComposition (MoreParents b (NoParents)) (Rule "other") (PNil)))
      (let c (SmoothRuleComposition (MoreParents boundary (NoParents)) (Rule "r") (RNil)))
      (let d (SmoothRuleComposition (MoreParents c (NoParents)) (Rule "r") (RNil)))
      ...
      (let packed_boundary (CoarseRuleComposition (MoreParents f1 (NoParents)) (Rule "other") (PNil)))
      ...
      (let outsider (Occurrence 88 (SmoothRuleComposition (MoreParents a (NoParents)) (Rule "consumer") (RNil))))
